...
#define ONLY_MSPACES 1			/* ONLY_MSPACES */
#ifndef MSPACES
#if ONLY_MSPACES
#define MSPACES 1
#else   /* ONLY_MSPACES */
...
#define DEFAULT_GRANULARITY (64*1024)  /* 0 means to compute in init_mparams */
  ...
  if (mparams.magic == 0) {
...
#else /* WIN32 */
    {
      ...
      gsize = ((DEFAULT_GRANULARITY != 0)?
               max(DEFAULT_GRANULARITY,system_info.dwAllocationGranularity) : system_info.dwAllocationGranularity);
    }
#endif /* WIN32 */
