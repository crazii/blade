/********************************************************************
	created:	2010/04/02
	filename: 	UISystemPlugin.h
	author:		Crazii
	
	purpose:	
*********************************************************************/
#ifndef __Blade_UISystemPlugin_h__
#define __Blade_UISystemPlugin_h__
#include <BladeUI.h>
#include <PluginBase.h>

namespace Blade
{
	class UISystemPlugin : public PluginBase
	{
	public:
		UISystemPlugin();
		~UISystemPlugin();
...
#endif //__Blade_UISystemPlugin_h__