...
QT_MOC_LITERAL(6, 89, 19), // "slotReadOnlyChanged"
QT_MOC_LITERAL(7, 109, 12), // "slotSetValue"
QT_MOC_LITERAL(8, 122, 11), // "slotEndEdit"
QT_MOC_LITERAL(9, 134, 19) // "slotEditorDestroyed"

    },
    "QtLineEditFactory\0slotPropertyChanged\0"
    "\0QtProperty*\0slotRegExpChanged\0"
    "slotEchoModeChanged\0slotReadOnlyChanged\0"
    "slotSetValue\0slotEndEdit\0slotEditorDestroyed"
};
#undef QT_MOC_LITERAL
...
void QtLineEditFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->d_func()->slotEndEdit(); break;
        case 6: _t->d_func()->slotEditorDestroyed((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        default: ;
        }
    }
...
QT_MOC_LITERAL(4, 54, 34), // "QtColorPropertyManager::value..."
QT_MOC_LITERAL(5, 89, 19), // "slotEditorDestroyed"
QT_MOC_LITERAL(6, 109, 12) // "slotSetValue"

    },
    "QtColorEditorFactory\0slotPropertyChanged\0"
    "\0QtProperty*\0QtColorPropertyManager::value_type\0"
...
void QtColorEditorFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->d_func()->slotPropertyChanged((*reinterpret_cast< QtProperty*(*)>(_a[1])),(*reinterpret_cast< const QtColorPropertyManager::value_type(*)>(_a[2]))); break;
        case 1: _t->d_func()->slotEditorDestroyed((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        case 2: _t->d_func()->slotSetValue((*reinterpret_cast< const QtColorPropertyManager::value_type(*)>(_a[1]))); break;
        default: ;
        }
    }
}
