/********************************************************************
created:	2011/09/03
filename: 	AtmosphereEditorPlugin.h
author:		Crazii
purpose:	
*********************************************************************/
#ifndef __Blade_AtmosphereEditorPlugin_h__
#define __Blade_AtmosphereEditorPlugin_h__
...
namespace Blade
{
	...
	class AtmosphereEditorPlugin : public PluginBase
	{
	public:
		AtmosphereEditorPlugin();
		~AtmosphereEditorPlugin();
	...
	protected:
		...
		//AtmosphereEditableSerializer	mEditableLoader;
	};//class AtmosphereEditorPlugin

}//namespace Blade


#endif //__Blade_AtmosphereEditorPlugin_h__