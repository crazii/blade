/********************************************************************
	created:	2015/09/24
	filename: 	ModelImporterPlugin.h
	author:		Crazii
	
	purpose:	
*********************************************************************/
#ifndef __Blade_ModelImporterPlugin_h__
#define __Blade_ModelImporterPlugin_h__
#include <PluginBase.h>

namespace Blade
{
	class ModelImporterPlugin : public PluginBase
	{
	public:
		ModelImporterPlugin();
		~ModelImporterPlugin();
...
#endif // __Blade_ModelImporterPlugin_h__