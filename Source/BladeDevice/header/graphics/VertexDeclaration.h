/********************************************************************
	...
	purpose:	
*********************************************************************/
#ifndef __Blade_VertexDeclaration_h__
#define __Blade_VertexDeclaration_h__
...
namespace Blade
{
	...
	protected:
		...
		typedef Map<uint16,int>		VertexElementSizeMap;

		VertexElementList		mElementList;
		VertexElementSizeMap	mSourceSizeMap;
	};
	
}//namespace Blade


#endif // __Blade_VertexDeclaration_h__