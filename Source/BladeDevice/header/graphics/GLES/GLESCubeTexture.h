/********************************************************************
	created:	2015/03/24
	filename: 	GLESCubeTexture.h
	author:		Crazii
	
	purpose:	
*********************************************************************/
#ifndef __Blade_GLESCubeTexture_h__
#define __Blade_GLESCubeTexture_h__
...
namespace Blade
{
	class GLESCubeTexture : public Texture, public Allocatable
	{
	public:
		GLESCubeTexture(GLuint name, IMG_ORIENT layout, size_t width,size_t height,PixelFormat format,
...
#endif // __Blade_GLESCubeTexture_h__
