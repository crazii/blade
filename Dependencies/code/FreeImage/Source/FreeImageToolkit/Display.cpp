...
FreeImage_Composite(FreeImageMem* mem, FIBITMAP *fg, BOOL useFileBkg, RGBQUAD *appBkColor, FIBITMAP *bg) {
	...
	FIBITMAP *composite = FreeImage_Allocate(mem,width, height, 24, FI_RGBA_RED_MASK, FI_RGBA_GREEN_MASK, FI_RGBA_BLUE_MASK);
	...
	FreeImage_CloneMetadata(mem,composite, fg);
