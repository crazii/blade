...
*/
DLL_API FIBITMAP * DLL_CALLCONV FreeImage_AllocateHeaderT(FreeImageMem* mem, BOOL header_only, FREE_IMAGE_TYPE type, int width, int height, int bpp FI_DEFAULT(8), unsigned red_mask FI_DEFAULT(0), unsigned green_mask FI_DEFAULT(0), unsigned blue_mask FI_DEFAULT(0));
...
*/
DLL_API FIBITMAP * DLL_CALLCONV FreeImage_AllocateHeader(FreeImageMem* mem, BOOL header_only, int width, int height, int bpp, unsigned red_mask FI_DEFAULT(0), unsigned green_mask FI_DEFAULT(0), unsigned blue_mask FI_DEFAULT(0));
