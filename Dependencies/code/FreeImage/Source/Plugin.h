...
extern "C" {
    ...
    void * DLL_CALLCONV FreeImage_Open(PluginNode *node, FreeImageIO *io, FreeImageMem* mem, fi_handle handle, BOOL open_for_reading);
    void DLL_CALLCONV FreeImage_Close(PluginNode *node, FreeImageIO *io, FreeImageMem* mem, fi_handle handle, void *data); // plugin.cpp
