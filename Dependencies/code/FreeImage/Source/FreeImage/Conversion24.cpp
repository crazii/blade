...
FreeImage_ConvertTo24Bits(FreeImageMem* mem, FIBITMAP *dib) {
	...
	if (bpp != 24) {
		...
		FIBITMAP *new_dib = FreeImage_Allocate(mem, width, height, 24, FI_RGBA_RED_MASK, FI_RGBA_GREEN_MASK, FI_RGBA_BLUE_MASK);
