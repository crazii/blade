...
FreeImage_ConvertTo32Bits(FreeImageMem* mem, FIBITMAP *dib) {
	...
	if(image_type == FIT_BITMAP) {
		...
		FIBITMAP *new_dib = FreeImage_Allocate(mem, width, height, 32, FI_RGBA_RED_MASK, FI_RGBA_GREEN_MASK, FI_RGBA_BLUE_MASK);
		if(new_dib == NULL) {
			return NULL;
		}
