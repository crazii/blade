...
*/
static BOOL 
jpeg_read_comment(FIBITMAP *dib, FreeImageMem* mem, const BYTE *dataptr, unsigned int datalen) {
	size_t length = datalen;
	BYTE *profile = (BYTE*)dataptr;

	// read the comment
	char *value = (char*)FreeImage_Malloc(mem->temp_mem, ((length + 1) * sizeof(char));
