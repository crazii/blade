...
static char *
ReadString(FreeImageIO *io, FreeImageMem* mem, fi_handle handle) {
	...
	char *cstr = (char *)FreeImage_Malloc(mem->temp_mem,s.length()+1);
	strcpy(cstr,s.c_str());
	return cstr;
}
